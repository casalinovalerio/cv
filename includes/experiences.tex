...
\begin{minipage}{.65\textwidth}
	...
	\smallskip
	\\
	\color{gray} Learning and training for web application security. My Internship relation is at the following link: { \color{SkyBlue} \url{https://bit.ly/2FI2wqm} \hspace{0.15em} \faFile }
	\vfill
\end{minipage}
